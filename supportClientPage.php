...
$MM_authorizedUsers = "Support Worker";
...
$MM_restrictGoTo = "employeePage.php";
...
<div id="navBar">
	<nav>
    	<ul>
        	...
        	<li><a href="supportClientPage.php">Clients</a></li>
            <li></li>
            <li></li>
            <li></li>
            <li></li>
