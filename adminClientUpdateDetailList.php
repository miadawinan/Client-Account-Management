...
<div id="content">
	<div id="pageHeading">
	  ...
	  <p>Please click on a client to update a user's information. To register a new client, please use the register new client form.</p>
	</div>
    <div id="contentLeft">
      <h3>Links      </h3>
    ...
    <div id="contentRight">
      <form id="updateForm" name="updateForm" method="post" action="">
        ...
        <table width="761" height="90" border="0">
          ...
          <?php do { ?>
            <tr>
              <td height="30"><a href="adminClientUpdateDetails.php?NHINumber=<?php echo $row_qClient['NHINumber']; ?>"><?php echo $row_qClient['NHINumber']; ?></a></td>
